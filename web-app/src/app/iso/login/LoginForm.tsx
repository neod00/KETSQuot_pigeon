  ...
  return (
    <form onSubmit={submit} className="mt-6 space-y-4">
      <div>
        ...
        <input id="username" autoComplete="username" placeholder="name@lrqa.com" value={username} onChange={(event) => setUsername(event.target.value)} className="w-full rounded-md border border-slate-300 px-3 py-2.5 outline-none focus:border-teal-600 focus:ring-2 focus:ring-teal-100" required />
      </div>
      <div>
